...
import { Code, Briefcase, User, Calendar, MapPin, Mail, Github, Linkedin } from "lucide-react"
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
              ...
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    ...
                    <CardDescription className="text-base font-medium text-primary">TechCorp Solutions</CardDescription>
                  </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    ...
                    <CardDescription className="text-base font-medium text-primary">StartupXYZ</CardDescription>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Calendar className="w-4 h-4" />
              ...
              <CardContent>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Developed and maintained 15+ React components in design system</li>
            ...
            <Card>
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    ...
                    <CardDescription className="text-base font-medium text-primary">Digital Agency Pro</CardDescription>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Calendar className="w-4 h-4" />
              ...
              <CardContent>
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• Implemented SEO best practices improving search rankings by 30%</li>
                  <li>• Maintained WordPress sites and custom PHP applications</li>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <article className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Full-stack e-commerce solution with payment integration, inventory management, and admin
                      dashboard.
                    </p>
        ...
        <div className="container mx-auto max-w-4xl">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    I thrive on tackling complex challenges and finding elegant solutions. Every bug is a puzzle waiting
                    to be solved.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Collaboration is key to great software. I believe in sharing knowledge, mentoring others, and
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Technology evolves rapidly, and so do I. I&apos;m always exploring new frameworks, tools, and best
                    practices.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    I believe great software is in the details. From clean code to pixel-perfect UIs, quality matters.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">⚡ Agile Mindset</h4>
                  <p className="text-sm text-muted-foreground">
                    I embrace iterative development, quick feedback loops, and adapting to changing requirements.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">🎨 User-Focused</h4>
                  <p className="text-sm text-muted-foreground">
                    Every line of code I write serves a user. I prioritize user experience and accessibility in all my
                    projects.
                  </p>
                </div>
              </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>What I do when I&apos;m not coding</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Marathon runner who finds clarity and inspiration on long runs. Currently training for my 5th
                    marathon.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-3 rounded-full bg-primary/10 flex items-center justify-center">
                    <span className="text-2xl" role="img" aria-label="Photography">
                      📸
                    </span>
                  </div>
                  <h4 className="font-semibold mb-2">Photography</h4>
                  <p className="text-sm text-muted-foreground">
                    Capturing moments and landscapes. Photography teaches me to see details and composition - skills
                    that transfer to UI design.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-3 rounded-full bg-primary/10 flex items-center justify-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Playing guitar and producing electronic music. Music and code both require rhythm, structure, and
                    creativity.
                  </p>
                </div>
              </div>
